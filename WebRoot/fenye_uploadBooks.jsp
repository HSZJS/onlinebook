				...
				<td align="right">
					...
					<div class="digg">
						...
						<s:if test="page.currentPageIndex>1">
							...
							<a href="book/findUploadBook?pn=${page.currentPageIndex-1}&userid=${user.id}">上一页</a>
						</s:if>
						...
						<s:iterator begin="page.startPageIndex" end="page.endPageIndex" status="i" var="p">
							...
							<s:else>
								...
								<a href="book/findUploadBook?pn=${p}&userid=${user.id}">${p }</a>
							</s:else>
						</s:iterator>

						<s:if test="page.currentPageIndex < page.totalPageNum">
							
							<a href="book/findUploadBook?pn=${page.currentPageIndex+1}&userid=${user.id}">下一页</a>
						</s:if>
                      </div>
					</div>
				</td>
