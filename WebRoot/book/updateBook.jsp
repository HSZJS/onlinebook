...
<div style="width:580; height:45" >
  ...
  <body>
     <div align="center">
     <form id="form" action="book/updateBook" method="post" enctype="multipart/form-data" onSubmit="return checkForm()" style="background-color:#EFF8FE; width:950px">
     <div align="center">
     <table width="950" border="0">
  <tr>
    <td width="240" height="77">&nbsp;</td>
    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="css/updatebook_title.png" width="250" height="30"></td>
    <td width="185"></td>
    <td width="18">&nbsp;</td>
    <td width="153">&nbsp;</td>
  </tr>
  <tr>
    <td height="38">&nbsp;</td>
    <td width="77">书名：</td>
    <td width="251"><input type="text" name="bookName" id="bookName" value="${bookInfo.name}"  onBlur="checkName()" style="height:30px; width:200px"></td>
  ...
  <tr>
    <td height="42">&nbsp;</td>
    <td>作者：</td>
    <td><input type="text" id="author" name="author" onBlur="checkAuthor()" value="${bookInfo.author}" style="height:30px; width:200px"></td>
    <td><span id="authorSpan">*必填信息(中文)</span></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="38">&nbsp;</td>
    <td>价钱:</td>
    <td><input type="text" id="price" name="price" onBlur="checkPrice()" value="${bookInfo.price}" style="height:30px; width:200px"></td>
    <td><span id="priceSpan">*必填信息</span></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="35">&nbsp;</td>
    <td>图书封面:</td>
    <td><img src="${bookInfo.pic}" name="pic" id="pic" width="120" height="150"/></td>
    <td><span id="picSpan" style="color:red"></span></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="42">&nbsp;</td>
    <td>出版社:</td>
    <td><input type="text" id="press" name="press" value="${bookInfo.press}" style="height:30px; width:200px"></td>
    <td><span id="pressSpan" style="color:red"></span></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="47">&nbsp;</td>
    <td>出版日期：</td>
    <td><input type="text" id="offerTime" name="offerTime" value="${bookInfo.offerTime}" style="height:30px; width:200px"></td>
    <td><span id="pressSpan" style="color:red"></span></td>
    <td></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="45">&nbsp;</td>
    <td>&nbsp;</td>
    <td><input type="hidden" name="bookid" value="${bookInfo.id}"></input>
   		<input type="hidden" name="userid" value="${user.id}"></input>
        <input type="image" value="修改" src="css/uoload_button.gif"></td>
