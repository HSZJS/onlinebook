...
<div style="width:580; height:45" >
  ...
  <body>
     <div align="center">
     <form id="form" action="book/uploadBook" method="post" enctype="multipart/form-data" onSubmit="return checkForm()" style="background-color:#EFF8FE; width:950px">
     <div align="center">
     <table width="950" border="0">
  <tr>
    <td width="240" height="77">&nbsp;</td>
    <td width="77">&nbsp;</td>
    <td width="291"><img src="css/upload_title.png" width="96" height="24"></td>
    <td width="145">&nbsp;</td>
    <td width="18">&nbsp;</td>
    <td width="153">&nbsp;</td>
  </tr>
  <tr>
    <td height="38">&nbsp;</td>
    <td>书名：</td>
    <td><input type="text" name="bookName" id="bookName"  onBlur="checkName()" style="height:30px; width:200px"></td>
  ...
  <tr>
    <td height="42">&nbsp;</td>
    <td>作者：</td>
    <td><input type="text" id="author" name="author" onBlur="checkAuthor()" style="height:30px; width:200px"></td>
  ...
  <tr>
    <td height="38">&nbsp;</td>
    <td>价钱:</td>
    <td><input type="text" id="price" name="price" onBlur="checkPrice()" style="height:30px; width:200px"></td>
  ...
  <tr>
    <td height="35">&nbsp;</td>
    <td>图书封面:</td>
    <td><input type="file" id="picFile" name="picFile" ></td>
  ...
  <tr>
    <td height="36">&nbsp;</td>
    <td>书籍简介:</td>
    <td><input type="file" id="bookFile" name="bookFile" onBlur="checkBook()"></td>
    <td><span id="bookSpan">*必填信息(txt格式)</span></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="38">&nbsp;</td>
    <td>所属分类:</td>
    <td><select id="one" name="one" onChange="createSecondLevel(this.value)">
      <option value="000">请选择分类</option>
      <option value="101000">玄幻</option>
      <option value="101100">武侠</option>
      <option value="101200">都市</option>
      <option value="101300">军事</option>
      <option value="101400">青春</option>
    </select>
      <select name="sortid" id="sortid">
        <option value="000">请选择子分类</option>
      </select></td>
    <td><span id="selectSpan">*必填信息</span></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
