...
<div style="width:580; height:45" >
  ...
  <body>
     <div align="center">
     <form id="form" action="book/saveChapterBook" method="post" enctype="multipart/form-data" onSubmit="return checkForm()" style="background-color:#EFF8FE; width:950px">
