...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="css/shuku.css">
...
document.getElementById("randImage").src = "user/image.jsp?"+Math.random(); 
  ...
  <s:if test="sessionScope.user != null">
  	...
  	<s:else>
  		欢迎来到欢迎来到悦读客，请<a href="javascript:void()" onClick="login()" style="color:red"><strong>登陆</strong></a> 
...
<div style="width:580; height:45" >
  ...
  <tr>
    ...
    <td><a href="user/registe.jsp">注册</a>|<a href="">忘记密码</a>|<a href="">反馈</a></td>
  </tr>
  <tr>
