...
<div style="width:580; height:45" >
  ...
  <script type="text/javascript">
		...
		function checkForm(){
			...
			if(bookFile == ""){
				flag = false;
				document.getElementById("bookSpan").innerHTML = "<b style='color:red;font-weight:lighter;font-size:14px'>请添加章节。 </b>";
  ...
  <body>
     <div align="center">
     <form id="form" action="book/editChapterBook" method="post" enctype="multipart/form-data" onSubmit="return checkForm()" style="background-color:#EFF8FE; width:950px">
  ...
  <tr>
    <td height="38">&nbsp;</td>
    <td>书名：</td>
    <td><input type="text" readOnly="true" name="bookName" id="bookName" value="<%=bookName %>" readOnly="true" style="height:30px; width:200px"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    <td height="42">&nbsp;</td>
    <td>当前章节:</td>
    <td><input type="text" id="press" name="press" readOnly="true" value="第<%=index %>章"  style="height:30px; width:200px"></td>
  ...
  <tr>
    <td height="38">&nbsp;</td>
    <td>章节名:</td>
    <td><input type="text" id="name" name="title" onBlur="checkPress()" style="height:30px; width:200px"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="42">&nbsp;</td>
    <td>作者：</td>
    <td><input type="text" id="author" name="author" value="${sessionScope.user.nickname }" readOnly="true" style="height:30px; width:200px"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
