...
<input type="hidden" id="email" name="email" value="<%= email%>"/>
  ...
  <tr>
    <td width="37" height="48">请输入新的密码:</td>
    <td width="206"><input type="text" style="width:200px; height:30px" id="password" name="password"></td>
    </tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  <tr>
    <td><input type="image" value="提交" src="css/uoload_button.gif" onclick="alert('修改成功');"></td></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
