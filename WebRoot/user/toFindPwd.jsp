...
<body>
  <div align="center">
   <form action="user/toAnswerJsp" method="post">
  ...
  <tr>
    <td width="37" height="48">你要找回的用户名:</td>
    <td width="206"><input type="text" style="width:200px; height:30px" id="loginname" name="loginname" onBlur="checkEmail(this.value)"></td>
    ...
    <td>&nbsp;</td>
  <tr>
    <td><input type="image" value="提交" src="css/uoload_button.gif"></td></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
