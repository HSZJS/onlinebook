					...
					<div class="digg">	
                      <div class="msdn">
						<s:if test="page.currentPageIndex>1">
							...
							<a href="sort/book?pn=${page.currentPageIndex-1}&code=${code}">上一页</a>
						</s:if>
						...
						<s:iterator begin="page.startPageIndex" end="page.endPageIndex" status="i" var="p">
							...
							<s:else>
								...
								<a href="sort/book?pn=${p}&code=${code}">${p }</a>
							</s:else>
						</s:iterator>

						<s:if test="page.currentPageIndex < page.totalPageNum">
							
							<a href="sort/book?pn=${page.currentPageIndex+1}&code=${code}">下一页</a>
						</s:if>
                      </div>
				  </div>
				</td>
